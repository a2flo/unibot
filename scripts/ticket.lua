...
function handle_message(origin, target, cmd, parameters)
	if cmd == "ticket" or cmd == "bug" then
		...
		send_private_msg(target, "Please open this link to send your "..ticket_type_str..": http://trac-git.assembla.com/unibot/newticket?reporter="..origin.."&summary="..summary.."&type="..ticket_type.."&version=0.2.x&milestone=v0.2")
	end
	return 0
end
